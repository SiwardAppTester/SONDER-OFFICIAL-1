          ...
          <div className="max-w-4xl mx-auto p-6 pt-36">
            <div className="bg-white/5 rounded-xl p-6 border border-white/10">
              <div className="prose prose-invert max-w-none prose-sm">
                <h1 className="text-2xl font-bold text-white mb-4">TERMS AND CONDITIONS FOR USERS OF THE SONDER PLATFORM</h1>
                
                <p className="text-white/80 text-sm">Last updated: 10-12-2024</p>

                <p className="text-white/80 text-sm">Welcome to Sonder! These Terms and Conditions ("Terms") govern your use of the Sonder platform, website, and services. By accessing or using the platform, you ("the User") agree to comply with and be bound by these Terms. If you do not agree, please do not use the platform.</p>
                ...
                <h2 className="text-lg font-semibold text-white mt-6">3. USER ELIGIBILITY</h2>
                <ul className="text-white/80 text-sm list-disc pl-8">
                ...
                <h2 className="text-lg font-semibold text-white mt-6">4. USER RESPONSIBILITIES</h2>
                <ul className="text-white/80 text-sm list-disc pl-8">
                ...
                <h2 className="text-lg font-semibold text-white mt-6">5. PAYMENTS AND REFUNDS</h2>
                <ul className="text-white/80 text-sm list-disc pl-8">
                ...
                <h2 className="text-lg font-semibold text-white mt-6">6. INTELLECTUAL PROPERTY</h2>
                <ul className="text-white/80 text-sm list-disc pl-8">
                ...
                <h2 className="text-lg font-semibold text-white mt-6">7. DATA PRIVACY</h2>
                <ul className="text-white/80 text-sm list-disc pl-8">
                ...
                <h2 className="text-lg font-semibold text-white mt-6">9. TERMINATION</h2>
                <ul className="text-white/80 text-sm list-disc pl-8">
                ...
                <h2 className="text-lg font-semibold text-white mt-6">10. MODIFICATIONS TO THE TERMS</h2>
                <ul className="text-white/80 text-sm list-disc pl-8">
                ...
                <h2 className="text-lg font-semibold text-white mt-6">11. GOVERNING LAW AND DISPUTES</h2>
                <ul className="text-white/80 text-sm list-disc pl-8">
                ...
                <p className="text-white/80 text-sm">For questions or concerns regarding these Terms, please contact us:</p>
                ...
                <p className="text-white/80 text-sm mt-6">By accessing or using the Sonder platform, you acknowledge that you have read, understood, and agree to these Terms and Conditions.</p>
              </div>
            </div>
          </div>
        </div>
