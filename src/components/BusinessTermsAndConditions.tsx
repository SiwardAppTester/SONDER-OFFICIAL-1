          ...
          <div className="max-w-4xl mx-auto p-6 pt-36">
            ...
            <div className="bg-white/5 rounded-xl p-6 border border-white/10">
              <div className="prose prose-invert max-w-none">
                <h1 className="text-3xl font-bold text-white mb-4">TERMS AND CONDITIONS FOR FESTIVALS USING THE SONDER PLATFORM</h1>
                
                <p className="text-white/80">Last updated: 10-12-2024</p>

                <p className="text-white/80">Welcome to Sonder! These Terms and Conditions (the "Agreement") govern your use of Sonder's software platform and services as a festival organizer or business partner. By accessing or using the Sonder platform, you ("the Festival") agree to comply with and be bound by these terms. If you do not agree, please refrain from using our services.</p>
                ...
                <h2 className="text-xl font-semibold text-white mt-6">3. OBLIGATIONS OF THE FESTIVAL</h2>
                <p className="text-white/80">The Festival agrees to:</p>
                ...
                <h2 className="text-xl font-semibold text-white mt-6">4. PAYMENT TERMS</h2>
                <ul className="text-white/80 list-disc pl-12">
                ...
                <h2 className="text-xl font-semibold text-white mt-6">6. DATA PRIVACY AND SECURITY</h2>
                <ul className="text-white/80 list-disc pl-12">
                ...
                <h2 className="text-xl font-semibold text-white mt-6">7. LIABILITY AND INDEMNIFICATION</h2>
                <ul className="text-white/80 list-disc pl-12">
                ...
                <h2 className="text-xl font-semibold text-white mt-6">8. TERMINATION</h2>
                <ul className="text-white/80 list-disc pl-12">
                ...
                <h2 className="text-xl font-semibold text-white mt-6">9. FORCE MAJEURE</h2>
                ...
                <h2 className="text-xl font-semibold text-white mt-6">10. DISPUTE RESOLUTION</h2>
                <ul className="text-white/80 list-disc pl-12">
                ...
                <h2 className="text-xl font-semibold text-white mt-6">11. MODIFICATIONS</h2>
                <ul className="text-white/80 list-disc pl-12">
                ...
                <p className="text-white/80">For questions or concerns regarding this Agreement, please contact Sonder at:</p>
                <p className="text-white/80">
                ...
                <p className="text-white/80 mt-6">By using Sonder's platform, you acknowledge that you have read, understood, and agree to these Terms and Conditions.</p>
              </div>
            </div>
          </div>
        </div>
