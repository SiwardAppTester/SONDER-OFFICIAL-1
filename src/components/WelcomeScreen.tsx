      ...
      {!showSignIn ? (
        <div className="w-full max-w-6xl mx-auto px-4 flex flex-col items-center relative z-10">
          ...
          <div className="text-center w-full">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-12 md:mb-24 animate-fade-in-up px-2 md:px-4 leading-tight">
            ...
            <div className="flex md:grid md:grid-cols-4 flex-row gap-2 md:gap-20 mb-12 md:mb-24 max-w-4xl mx-auto px-2 md:px-4 overflow-x-auto md:overflow-x-visible">
              {[
                ...
                >
                  ...
                  <div className="w-12 h-12 md:w-20 md:h-20 bg-white rounded-full flex items-center justify-center mb-2 md:mb-4 shadow-lg hover:shadow-purple-500/50 transition-shadow duration-300">
                    <svg className="w-6 h-6 md:w-10 md:h-10 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={feature.icon} />
                    </svg>
                  </div>
                  {/* Feature title - Smaller text for mobile */}
                  <span className="text-gray-900 font-medium text-[10px] md:text-lg text-center leading-tight whitespace-nowrap">
                    {feature.title}
                  </span>
                </div>
              ))}
            ...
            {/* Join Button - Enhanced mobile appearance */}
            <div className="max-w-[280px] md:max-w-md mx-auto mb-10 md:mb-24 px-2 md:px-4 transform hover:scale-105 transition-all duration-300">
              <div className="relative">
                <button
                  ...
                  className="w-full px-6 md:px-8 py-3.5 md:py-4 rounded-full bg-purple-600 text-white font-semibold text-base md:text-xl 
                           transition-all duration-300 
                           shadow-[0_0_15px_rgba(168,85,247,0.4)] md:shadow-[0_0_20px_rgba(168,85,247,0.5)]
                           hover:shadow-[0_0_20px_rgba(168,85,247,0.6)] md:hover:shadow-[0_0_30px_rgba(168,85,247,0.8)]
            ...
            {/* Footer - Refined mobile text */}
            <footer className="text-center text-gray-600 px-2 md:px-4">
